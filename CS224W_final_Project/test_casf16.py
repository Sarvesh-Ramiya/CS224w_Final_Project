...
with open('/Users/rbasto/Stanford projects/CS224W/general-set-2020-6-6-6_test.pkl', 'rb') as f:
...
best_model.load_state_dict(torch.load("/Users/rbasto/Downloads/fused_MD_hdim_64_batch_16.pt",  map_location=torch.device('cpu')))
